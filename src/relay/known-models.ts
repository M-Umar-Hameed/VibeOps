...
export const KNOWN_AGENT_MODELS: Record<string, KnownModel[]> = {
  ...
  agy: [
    { id: "gemini-3.8-flash-high", name: "Gemini 3.8 Flash (High)", tier: "cheap", quality: 5 },
    { id: "gemini-3.7-flash-high", name: "Gemini 3.7 Flash (High)", tier: "cheap", quality: 4 },
    { id: "gemini-3.6-flash-high", name: "Gemini 3.6 Flash (High)", tier: "cheap", quality: 3 },
    { id: "gemini-3.1-pro-high", name: "Gemini 3.1 Pro (High)", tier: "expensive", quality: 4 },
    { id: "claude-opus-4-6-thinking", name: "Claude Opus 4.6 (Thinking)", tier: "expensive", quality: 4 },
    { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6 (Thinking)", tier: "cheap", quality: 3 },
