    ...
    <aside className={`fixed left-0 top-0 h-full w-[280px] bg-surface-container/95 md:bg-surface-container/60 backdrop-blur-xl border-r border-white/10 flex flex-col py-6 z-50 translate-x-0`}>
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden flex flex-col">
        <nav className="space-y-1 mb-8">
          ...
          >
            <span className="material-symbols-outlined" style={{ fontVariationSettings: isActive("/chat") ? "'FILL' 1" : "" }}>chat</span>
          ...
          >
            <span className="material-symbols-outlined" style={{ fontVariationSettings: isActive("/usage") ? "'FILL' 1" : "" }}>insights</span>
