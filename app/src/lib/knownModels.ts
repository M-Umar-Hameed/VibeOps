...
export const KNOWN_AGENT_MODELS: Record<string, KnownModel[]> = {
  claude: [
    { id: "claude-fable", name: "Claude Fable", tier: "expensive", quality: 5 },
    { id: "Fable", name: "Fable", tier: "expensive", quality: 5 },
    { id: "claude-opus", name: "Claude Opus", tier: "expensive", quality: 5 },
    { id: "Opus 5", name: "Opus 5", tier: "expensive", quality: 5 },
    { id: "claude-sonnet", name: "Claude Sonnet", tier: "cheap", quality: 4 },
    { id: "Sonnet", name: "Sonnet", tier: "cheap", quality: 4 },
    { id: "claude-haiku", name: "Claude Haiku ", tier: "free", quality: 3 },
  ...
  "claude-sdk": [
    ...
    { id: "claude-sonnet", name: "Claude Sonnet", tier: "cheap", quality: 4 },
    { id: "Sonnet", name: "Sonnet", tier: "cheap", quality: 4 },
    { id: "claude", name: "Claude", tier: "expensive", quality: 5 },
    { id: "Claude", name: "Claude", tier: "expensive", quality: 5 },
    { id: "claude-haiku", name: "Claude Haiku", tier: "free", quality: 3 },
    { id: "Haiku", name: "Haiku", tier: "free", quality: 3 },
  ],
  agy: [
    { id: "Gemini 3.8 Flash", name: "Gemini 3.8 Flash", tier: "cheap", quality: 4 },
    { id: "Gemini 3.7 Flash", name: "Gemini 3.7 Flash", tier: "expensive", quality: 5 },
    { id: "Gemini 3.6 Flash", name: "Gemini 3.6 Flash", tier: "cheap", quality: 3 },
    { id: "Gemini 3.5 Flash", name: "Gemini 3.5 Flash", tier: "free", quality: 2 },
    { id: "Gemini 3.1 Pro", name: "Gemini 3.1 Pro", tier: "cheap", quality: 4 },
    { id: "Claude Opus 4.6 (Thinking)", name: "Claude Opus (Thinking)", tier: "expensive", quality: 5 },
    { id: "Claude Sonnet 4.6 (Thinking)", name: "Claude Sonnet 4.6 (Thinking)", tier: "cheap", quality: 4 },
